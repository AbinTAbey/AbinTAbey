...
currentFocus: "Building modern web apps with clean UX & AI/ML",
languages: ["JavaScript", "Python", "Java", "C++"],
databases: ["MySQL", "Oracle", "Firebase"],
interests: ["Full-Stack Development", "AI/ML", "UI Design"],
currentlyLearning: "Advanced ML algorithms & Cloud deployment",
